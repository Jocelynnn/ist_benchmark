...
\begin{figure}
\centering
\subfigure[Precision/recall value of BJ with human-made and auto-generate labels] { \label{fig:a3}
\includegraphics[width=0.4\columnwidth]{images/bj-eva.png}
}
\subfigure[Precision/recall value of GSC with human-made and auto-generate labels] { \label{fig:b3}
\includegraphics[width=0.4\columnwidth]{images/gsc-eva.png}
}
\subfigure[Precision/recall value of RW with human-made and auto-generate labels] { \label{fig:c3}
\includegraphics[width=0.4\columnwidth]{images/rw-eva.png}
}
\subfigure[Precision/recall value of SP with human-made and auto-generate labels] { \label{fig:d3}
\includegraphics[width=0.4\columnwidth]{images/sp-eva.png}
}
